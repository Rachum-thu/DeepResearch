#!/bin/bash
#
# Run DeepResearch inference on deepresearch_bench SUBSET (3 queries)
...
echo "=========================================="
echo "DeepResearch Bench - SUBSET Test (3 queries)"
echo "=========================================="
echo ""
...
# Configuration
DATASET="$DEEPRESEARCH_ROOT/data/deepresearch_bench_subset/bench_queries.jsonl"
OUTPUT_DIR="$DEEPRESEARCH_ROOT/output/deepresearch_bench_subset"
...
echo ""
echo "=========================================="
echo "✓ Subset inference completed!"
